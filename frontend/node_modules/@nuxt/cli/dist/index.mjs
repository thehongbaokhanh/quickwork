...
const commands = {
	"add": () => import("./add-nj6hd6cc.mjs").then(_rDefault),
	"add-template": () => import("./add-template-cTcq62Qd.mjs").then(_rDefault),
	"analyze": () => import("./analyze-DZ0kazi_.mjs").then(_rDefault),
	"build": () => import("./build-DWst0L5A.mjs").then(_rDefault),
	"cleanup": () => import("./cleanup-2TBoIdxA.mjs").then(_rDefault),
	"_dev": () => import("./dev-child-B2FK5OT1.mjs").then(_rDefault),
	"dev": () => import("./dev-CGT_SblH.mjs").then(_rDefault),
	"devtools": () => import("./devtools-DisdwL4R.mjs").then(_rDefault),
	"generate": () => import("./generate-DJpMuzgA.mjs").then(_rDefault),
	"info": () => import("./info-Dal77t78.mjs").then(_rDefault),
	"init": () => import("./init-DQykC0LD.mjs").then(_rDefault),
	"module": () => import("./module-C8B3XjBd.mjs").then(_rDefault),
	"prepare": () => import("./prepare-Dg6Tsv5Z.mjs").then((n) => n.n).then(_rDefault),
	"preview": () => import("./preview-3Aqd-TmN.mjs").then(_rDefault),
	"start": () => import("./preview-3Aqd-TmN.mjs").then(_rDefault),
	"test": () => import("./test-CmZfAqxV.mjs").then(_rDefault),
	"typecheck": () => import("./typecheck-DfovnEXZ.mjs").then(_rDefault),
	"upgrade": () => import("./upgrade-C_xjgZpj.mjs").then(_rDefault)
};
//#endregion
...
async function runMain() {
	if (process.argv[2] === "complete") {
		const { initCompletions } = await import("./completions-CkDgLCqG.mjs");
