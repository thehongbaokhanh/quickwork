...
function createConfigForNuxt(options = {}, ...userConfigs) {
  ...
  if (resolved.features.standalone !== false) {
    c.append(
      ...
      import('../chunks/typescript.mjs').then(
        (m) => resolved.features.typescript !== false ? m.default(resolved) : []
      ),
  ...
  if (resolved.features.tooling) {
    ...
    c.append(
      import('../chunks/jsdoc.mjs').then(
        (m) => toolingOptions.jsdoc !== false ? m.default(resolved) : []
      ),
      import('../chunks/unicorn.mjs').then(
        (m) => toolingOptions.unicorn !== false ? m.default() : []
      ),
      import('../chunks/regexp.mjs').then(
        (m) => toolingOptions.regexp !== false ? m.default() : []
      )
    );
  }
...
export { resolveOptions as a, createConfigForNuxt as c, defineFlatConfigs as d, ensurePackages as e, interopDefault as i, parserPlain as p, removeUndefined as r };
