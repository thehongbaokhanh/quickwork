...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "min-h-screen bg-gray-50 flex flex-col text-gray-900" },
});
...
__VLS_asFunctionalElement1(__VLS_intrinsics.header, __VLS_intrinsics.header)({
    ...{ class: "bg-white border-b border-gray-200 sticky top-0 z-40 h-16 flex items-center justify-between px-4 lg:px-6" },
});
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "h-full px-3 py-4 overflow-y-auto flex flex-col justify-between" },
});
...
__VLS_asFunctionalElement1(__VLS_intrinsics.a, __VLS_intrinsics.a)({
    href: "#",
    ...{ class: "flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group bg-gray-100" },
});
/** @type {__VLS_StyleScopedClasses['flex']} */ ;
/** @type {__VLS_StyleScopedClasses['items-center']} */ ;
/** @type {__VLS_StyleScopedClasses['p-2']} */ ;
...
/** @type {__VLS_StyleScopedClasses['ms-3']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "p-2 border-t border-gray-100 text-xs text-gray-400 text-center" },
});
/** @type {__VLS_StyleScopedClasses['p-2']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.main, __VLS_intrinsics.main)({
    ...{ class: "flex-1 p-4 md:p-6 max-w-7xl mx-auto w-full min-w-0" },
});
/** @type {__VLS_StyleScopedClasses['flex-1']} */ ;
